-- Fix messages table: Add user_id column if missing (v2 - fixed foreign key issue)
...
BEGIN
    ...
    RAISE NOTICE 'user_id column exists: %', col_exists;
    RAISE NOTICE 'Total messages in table: %', msg_count;
END $$;